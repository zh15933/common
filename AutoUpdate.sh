...
if [[ "${AutoUpdate_Mode}" == "1" ]]; then
  ...
  curl -fsSL https://ghproxy.com/https://raw.githubusercontent.com/shidahuilang/common/main/Custom/Detectionnetwork > /mnt/Detectionnetwork
  if [[ $? -ne 0 ]]; then
    wget -P /mnt https://raw.githubusercontent.com/shidahuilang/common/main/Custom/Detectionnetwork -O /mnt/Detectionnetwork
  fi
  if [[ $? -eq 0 ]]; then
