...
echo "GENE_PATH=${GITHUB_WORKSPACE}/openwrt/package/base-files/bin/config_generate" >> ${GITHUB_ENV}
echo "GENE_PATH=${GITHUB_WORKSPACE1}/openwrt/package/base-files/luci2/bin/config_generate" >> ${GITHUB_ENV}
